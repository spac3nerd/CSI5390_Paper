...
var Point = module.exports.Point = function(args) {
  this.x = 0.0000000000000000;
  this.y = 0.0000000000000000;
  this.z = 0.0000000000000000;
  if (args) {
...
var Pose = module.exports.Pose = function(args) {
  ...
  if (args) {
    ...
    if (args.ori !== undefined && args.ori !== null) {
      ...
      throw new Thrift.TProtocolException(Thrift.TProtocolExceptionType.UNKNOWN, 'Required field ori is unset!');
    }
  }
};
Pose.prototype = {};
