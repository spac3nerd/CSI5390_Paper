...
class Point(object):
    ...
    def __init__(self, x=0.0000000000000000, y=0.0000000000000000, z=0.0000000000000000,):
        self.x = x
        self.y = y
        self.z = z
...
class Pose(object):
    ...
    def validate(self):
        ...
        if self.ori is None:
            raise TProtocolException(message='Required field ori is unset!')
        return
...
Point.thrift_spec = (
    None,  # 0
    (1, TType.DOUBLE, 'x', None, 0.0000000000000000, ),  # 1
    (2, TType.DOUBLE, 'y', None, 0.0000000000000000, ),  # 2
    (3, TType.DOUBLE, 'z', None, 0.0000000000000000, ),  # 3
)
