...
around its position. Fig 4. shows a simple example of a car being rotates about the Z axis. The simplest method by which this information can be encoded 
...
the project code is located at (https://github.com/spac3nerd/CSI-5380Proj). The nodejs server 
